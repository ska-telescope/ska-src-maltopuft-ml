...
parser.add_argument(
    "-dd",
    "--data_dir",
    help="The directory where the hdf5 candidates are located",
    type=str,
...
parser.add_argument(
    "-rd",
    "--result_dir",
    help="The directory where the csv file after prediction will be saved",
    type=str,
    default="./data/results_csv/",
)
parser.add_argument(
    "-m",
    "--model_cnn_name",
    help="The network name choose from: NET1_32_64  NET1_64_128  NET1_128_256  NET2  NET3",
    type=str,
    default="NET3",
)
parser.add_argument(
    "-n",
    "--n_images",
    help="The images to consider and can take str as either dm_fq_time dm_time fq_time",
    type=str,
    default="dm_fq_time",
)
parser.add_argument(
...
data_dir, result_dir, model_cnn_name, n_images, probability = (
    args.data_dir,
    args.result_dir,
    args.model_cnn_name,
    args.n_images,
...
overall_real_prob, overall_dataframe = FRB_prediction(
